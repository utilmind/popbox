      ...
      doInit(function() {
        ...
        if (me.show_on_scroll_end > me.show_on_scroll_start) {
          $(window).scroll(function(e) {
            ...
            //console.log("top " + scrollTop + ", bottom: " + (scrollTop + document.body.clientHeight) +
            //  ", start: " + document.body.scrollHeight / 100 * me.show_on_scroll_start + ", end: " + document.body.scrollHeight / 100 * me.show_on_scroll_end);

            if (((scrollTop + document.body.clientHeight) > (document.body.scrollHeight / 100 * me.show_on_scroll_start)) &&
